...
onMounted(async () => {
  ...
  try {
    ...
    console.log(currentUsulan.value)
    usulanTaList.value = currentUsulan.value.usulanTa
  ...
  <div class="body-head-side">
    <div class="p-2 text-sm">
              ...
              <div class="flex flex-col">
                <div v-if="usulan.mhs_pengusul.length !== 0" class="border-b border-[#334D80] mb-1 pb-1">
                  ...
                  <span v-if="usulan.mhs_pengusul.length !== 0">
                    <span v-for="(mhs, index) in usulan.mhs_pengusul">
                      <LihatMhs :mhs="mhs" :taId="usulan.id" />
                      <span v-if="usulan.mhs_pengusul.length > 1 && (index + 1) !== usulan.mhs_pengusul.length">,
                      </span>
                    </span>
                  </span>
                </div>
      ...
      <div class="flex flex-wrap my-2">
        <BuatUsulan :currentUsulan="currentUsulan" />
      </div>
    </div>
  </div>
</template>